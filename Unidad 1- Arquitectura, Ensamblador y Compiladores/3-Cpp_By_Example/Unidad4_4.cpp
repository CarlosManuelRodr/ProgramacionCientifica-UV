...
/* Ejercicio 1: Implementar el metodo de Newton-Raphson para f(z) := sen(z) - z
   Ejercicio 2: Graficar la convergencia del método de Newton-Raphson con la ecuación f(x) = Cos(x) - x.
 */
